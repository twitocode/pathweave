...
func TestScrapeIngestBuildSectionReferences(t *testing.T) {
	sections := []normalizedSection{
		{ID: 1, Type: "LEC", InstructorSet: map[string]struct{}{"Jane Doe": {}}},
		{ID: 2, Type: "LAB", InstructorSet: map[string]struct{}{"Jane Doe": {}}},
		{ID: 3, Type: "TUT", InstructorSet: map[string]struct{}{}},
		{ID: 4, Type: "LAB", InstructorSet: map[string]struct{}{"Other Person": {}}},
	}
