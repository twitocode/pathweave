...
SELECT sc.id, sc.combo_index, sc.day, sc.start_time, sc.end_time, sc.type, sc.section, sc.instructor_name, sc.building, sc.room, sc.mode, sc.is_in_person, sc.course_id, t.avg_difficulty, t.avg_rating
